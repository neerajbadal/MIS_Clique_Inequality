...
#     plt.show()
    ...
    result_array = []
    outDataFile = "D:/Mtech/FY/SEM2/Latex_Assignment/proj_out_greedy_approx_v14.dat"
    for j in range(0,30):
        for nr_ in range(10,30,1):
...
#                 y_val = random.randrange(planeYRange[0]+heightRange[0],planeYRange[1]-heightRange[1])
                ...
                perturb_ = (float(i) / numberOfRectangles) * random.randint(2,5) 
...
#             heuristicMIS_forData = greedyMISII.prepareGreedyMISDI(input_rectangles)
